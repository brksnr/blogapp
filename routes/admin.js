...
router.post("/blog/create",isModerator, csrf,imgUpload.upload.single("resim") ,adminController.post_blog_create);
...
router.post("/blogs/:blogid",isModerator, imgUpload.upload.single("resim") , adminController.post_blog_edit);
